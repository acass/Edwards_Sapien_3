...
public class GenerateImageAnchor : MonoBehaviour {
	...
	{
        mText.text = "image anchor added: " + arImageAnchor.referenceImageName + "  tracked: " + arImageAnchor.isTracked;
	...
	void UpdateImageAnchor(ARImageAnchor arImageAnchor)
	{
        ...
        mText.text = "image anchor updated: " + arImageAnchor.referenceImageName + "  tracked: " + arImageAnchor.isTracked;
	...
	{
        mText.text = "image anchor removed: " + arImageAnchor.referenceImageName + "  tracked: " + arImageAnchor.isTracked;
